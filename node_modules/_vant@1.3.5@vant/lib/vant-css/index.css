...
.van-picker__loading .van-loading {
	...
	/*z-index: -1;*/
	/*border-top: 0.013333rem solid white;*/
	/*border-bottom: 0.013333rem solid white;*/
}
...
.van-address-item--disabled .van-radio__input {
	display: none
}

.van-address-item--disabled .van-radio__label {
	padding-left: 0
}
